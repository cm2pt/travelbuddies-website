...
const copy = {
  pt: {
    ...
    baseTitle: 'Viagem à Medida',
    premiumTitle: 'Viagem sem Troubles',
    ...
    simulatorBase: 'Viagem à Medida',
    simulatorPremium: 'Viagem sem Troubles',
    simulatorFree: 'Reserva e Vai',
    ...
    faqItems: [
      ...
      { q: 'Posso só pedir a marcação, sem planeamento?', a: 'Claro! O serviço "Reserva e Vai" é gratuito: pesquisamos, comparamos e marcamos por ti.' },
      ...
      { q: 'O que acontece durante a viagem?', a: 'No plano Viagem sem Troubles, tens suporte durante toda a viagem. No Viagem à Medida, apoio na preparação e decisão.' },
    ],
  ...
  en: {
    ...
    baseTitle: 'Tailored Trip',
    premiumTitle: 'Trouble-Free Trip',
    ...
    simulatorBase: 'Tailored Trip',
    simulatorPremium: 'Trouble-Free Trip',
    simulatorFree: 'Book & Go',
    simulatorBasePrice: '~{price}€',
    ...
    faqItems: [
      ...
      { q: 'Can I just get booking help, no planning?', a: 'Of course! The "Book & Go" service is free: we search, compare, and book for you.' },
      ...
      { q: 'What happens during the trip?', a: 'With Trouble-Free Trip, you get support throughout your trip. With Tailored Trip, we help with preparation and decisions.' },
    ],
